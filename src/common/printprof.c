...
typedef struct _print_profile_data_t
{
...
// Transform one image
static
int TransformImage(print_profile_data_t *pp)
{
  ...
  default: FatalError("Unknown precalculation mode '%d'", pp->PrecalcMode);
  }
